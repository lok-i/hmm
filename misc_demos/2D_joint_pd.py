...
pd_controller = PDController(
                             kps=np.full(env.n_act_joints,103),
                             kds=np.full(env.n_act_joints,0.8),
                             )
...
joint_actuator_to_chk = "right_leg/hip_y"
